  ...
  <q-card>
    <q-card-section class="row">
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 q-pr-xs">
        <q-file
          bottom-slots
          v-model="candidato.url_Foto_Propietario"
          label="Fotografía"
          counter
        >
          <template v-slot:prepend>
            <q-avatar v-if="isEditar">
              <img :src="candidato.url_Foto_Propietario" />
            </q-avatar>
          ...
          <template v-slot:append>
            <q-icon
              name="close"
              @click.stop.prevent="candidato.url_Foto_Propietario = null"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model="candidato.nombres_Propietario"
          label="Nombre(s)"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model="candidato.apellido_Paterno_Propietario"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model="candidato.apellido_Materno_Propietario"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model="candidato.mote_Propietario"
          label="Mote"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model.trim="candidato.clave_Elector_Propietario"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model.trim="candidato.curp_Propietario"
          label="CURP"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model.trim="candidato.rfc_Propietario"
          label="RFC"
          hint="Ingrese su RFC"
          counter
          maxlength="13"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model="candidato.fecha_Nacimiento_Propietario"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 q-pr-xs">
        <q-select
          v-model="candidato.sexo_Propietario"
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <q-input
          v-model="candidato.ocupacion_Propietario"
          label="Ocupación"
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 q-pr-xs">
        <q-input
          v-model.trim="candidato.correo_Propietario"
          type="email"
      ...
      <div v-if="isExtension" class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
        <q-input
          v-model.number="candidato.value.extension_Prop"
          type="number"
          label="Extensión"
          hint="Extensión"
          autogrow
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <q-checkbox
          ...
          size="lg"
          v-model="candidato.pertenece_Grupo_Vulnerable_Propietario"
          color="pink"
        />
      </div>
      <div
      ...
      >
        <q-input
          v-model="candidato.grupoProp_1"
          label="Personas de pueblos y comunidades indígenas"
        >
        </q-input>
        <q-input v-model="candidato.grupoProp_2" label="Diversidad sexual">
        </q-input>
      </div>
      <div
        v-if="candidato.pertenece_Grupo_Vulnerable_Propietario == true"
      ...
      >
        <q-input
          v-model="candidato.grupoProp_3"
          label="Personas con discapacidad"
        >
        </q-input>
        <q-input v-model="candidato.grupoProp_4" label="Otro"> </q-input>
      </div>
    </q-card-section>
  </q-card>
</template>
...
const { candidato, isEditar } = storeToRefs(candidatoStore);
